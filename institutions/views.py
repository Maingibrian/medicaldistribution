...
def delete_med_distribution(request, pk):
    ...
    return render(request, "auditorHome.html", context)

def institution_details(request, pk):
    Institution = institution.objects.get(id=pk)

    info = Institution.medication_package_set.all()
    context = {
...
def admin_report(request):
    ...
    table_headers = ["Institution Name", "Location", "Package ID", "Medication Name", "Batch Number", "Quantity", "Status"]
